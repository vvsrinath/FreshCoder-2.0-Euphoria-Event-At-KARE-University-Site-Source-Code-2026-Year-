...
const CAMPUS_IMAGE = "/9cb28c2e-9594-4a33-a139-2fed5049df91.jpg";
    ...
    <div className="min-h-screen w-full bg-[#f8fafc] flex flex-col justify-between">
      <div className="grid min-h-[calc(100vh-80px)] w-full lg:grid-cols-[1.1fr_1.2fr]">
        ...
        <aside className="relative hidden overflow-hidden bg-[#0a1026] lg:flex lg:flex-col justify-between p-10 lg:p-14 text-white">
          <img
            src={CAMPUS_IMAGE}
            alt="Kalasalingam Academy of Research and Education campus"
          ...
          <div className="relative z-10">
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 inline-flex items-center gap-2 rounded-lg border border-sky-400/30 bg-sky-500/10 px-3.5 py-1.5 backdrop-blur-md">
                <span className="h-2 w-2 rounded-full bg-sky-400 animate-ping" />
                <span className="text-xs font-bold text-sky-200">
                  EUPHORIA 2026 · A Techno Management Meet
                </span>
              </div>
            </div>
          </div>
